...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ioi7xwg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ioi7xwg.containers.anotherwebservice.com/
...
```
git clone git@github.com:WeberIT/container-ioi7xwg.git
cd container-ioi7xwg
```
...
```
docker attach container-ioi7xwg
```
